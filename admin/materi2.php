...
font-size: 16px;">Selamat Datang <b><?php echo $username; ?></b>  <a href="../login/logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                ...
                <?php 
                include("koneksi.php");
                $query=mysqli_query($koneksi,"SELECT * FROM tambah ORDER BY id");
                ...
                <div class="col-md-4 col-sm-4">
                 ...
                 ?>
                        <div class="panel-footer">
                            ...
                            <a href="delete.php?id=<?php echo $data['id']; ?>" class="btn btn-danger" align="right" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
                        </div>
                    </div>
                </div>
